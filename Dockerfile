...
COPY ./zabbix/simkai.ttf             /usr/share/zabbix/fonts/simkai.ttf 

#替换字体文件
RUN  cd /usr/share/zabbix && sed -i 's/graphfont/simkai/g' ./include/defines.inc.php
